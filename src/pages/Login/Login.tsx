    ...
    <section className="min-h-screen overflow-hidden flex flex-col justify-center">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center tracking-wider lg:pb-6">
          <h1 className="text-3xl lg:text-7xl font-extrabold lg:mb-4">
            Keep your{" "}
          ...
          <span className="text-3xl lg:text-7xl font-extrabold lg:mb-4 bg-clip-text text-transparent bg-gradient-to-r from-emerald-700 to-emerald-200 -mt-2">
            Whatcents
          </span>
          ...
          <div className="grid lg:grid-cols-3 gap-4 mb-10 lg:mb-0 mt-10 mx-6 text-left justify-center lg:text-xl text-gray-400">
            <div className="border-gray-600 lg:border-r-2">
              ...
              <p className="text-center lg:text-left">Add all of your monthly expenses</p>
            </div>
            <div className="border-gray-600 lg:border-r-2">
              <p className="flex-none text-white font-bold">Step 2:</p>
              <p className="text-center lg:text-left">Add your average paycheck income</p>
            </div>
            <div>
              <p className="flex-none text-white font-bold">Done!</p>
              <p className="text-center lg:text-left">Whatcents will tell you how much you have left!</p>
            </div>
          </div>
        </div>
